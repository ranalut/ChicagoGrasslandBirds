...
# 
# data <- read.csv('C:/Chicago_Grasslands/acreage_totals_per_county_clean2.csv')
# 
# data <- data[,c(2,4:16)]
# 
...
#                  )
#   
#   write.csv(cdata,paste(file_path,counties[i],'_total_ac_es_clean.csv',sep=''))
# 
# }

# combine all counties into one master csv so that you can easily join to feature class
dat1 <- read.csv('C:/Chicago_Grasslands/Cook_total_ac_es_clean.csv')
dat2 <- read.csv('C:/Chicago_Grasslands/DuPage_total_ac_es_clean.csv')
dat3 <- read.csv('C:/Chicago_Grasslands/Kane_total_ac_es_clean.csv')
dat4 <- read.csv('C:/Chicago_Grasslands/Kendall_total_ac_es_clean.csv')
dat5 <- read.csv('C:/Chicago_Grasslands/Lake_total_ac_es_clean.csv')
dat6 <- read.csv('C:/Chicago_Grasslands/McHenry_total_ac_es_clean.csv')
dat7 <- read.csv('C:/Chicago_Grasslands/Will_total_ac_es_clean.csv')

dat_merge <- rbind(dat1,dat2,dat3,dat4,dat5,dat6,dat7)

write.csv(dat_merge,paste(file_path,'CMAP_totals_ac_es_clean.csv',sep=''))
